            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-lg shadow-sm mb-6 flex flex-col md:flex-row gap-4 items-end md:items-end">
                ...
                <div className="w-full md:w-auto">
                    <button
                        ...
                        className="w-full md:w-auto px-6 py-3 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors font-medium whitespace-nowrap border border-transparent"
                    >
                        Clear Filters
                    </button>
                </div>
