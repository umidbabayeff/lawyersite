...
import { getCommunityRequestById, updateCommunityRequest, getConstants } from "@/lib/services";
...
export default function EditRequestPage() {
    ...
    useEffect(() => {
        if (id && user) {
            getCommunityRequestById(id as string).then((req) => {
                if (req) {
                    ...
                    setCity(req.location);
                    setSpecialty(req.specialty);
                    setBudget(req.budget?.toString() || "");
                    setLoading(false);
                } else {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        try {
            await updateCommunityRequest(id as string, {
                title,
                description,
                location: city,
                specialty,
            ...
            // Redirect to updated request details
